        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="https://i.imgur.com/vvElTRn.png" width="23" height="23" />&nbsp; <font size="3">Coronet - Tabulation System</font></a>
...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h1>Data Reviews</h1>
    <p class="lead">Coronet - Tabulation System</p>
  </div>
</header>
    <div class="container">
 ...
 <div class="panel panel-primary">
  ...
  <tbody>
   <?php    
   	$mainevent_query = $conn->query("SELECT * FROM main_event");
